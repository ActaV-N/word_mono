...
const ZoopInput:React.FC<Props> = ({content, meaning, onChange}) => {
    return <>
      ...
      <TextField tails="rounded-b-none" name="content" onChange={onChange} value={content} align='center' label='오늘은 어떤 표현을 줍줍하셨나요? ⏎' />
